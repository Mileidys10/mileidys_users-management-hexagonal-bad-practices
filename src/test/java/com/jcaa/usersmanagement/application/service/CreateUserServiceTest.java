...
class CreateUserServiceTest {
  ...
  @Test
  @DisplayName("Debe guardar al usuario y notificar cuando el correo es nuevo")
  ...
  @Test
  @DisplayName("Debe lanzar una excepción cuando el correo ya existe")
  ...
  @Test
  @DisplayName("Debe lanzar una excepción cuando el comando es inválido")
