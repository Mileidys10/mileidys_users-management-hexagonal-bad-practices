...
public final class PersistenceException extends RuntimeException {
    ...
    private static final String DELETE_USER_FAILED_MSG ="Failed to delete user with ID: '%s'.";
    private static final String FAILED_CONNECTION = "Could not establish database connection.";
    ...
    public static PersistenceException becauseDeleteFailed(
            final String userId, final Throwable cause) {
        return new PersistenceException(String.format(DELETE_USER_FAILED_MSG, userId), cause);
    }

    public static PersistenceException becauseConnectionFailed(final Throwable cause) {
        return new PersistenceException(FAILED_CONNECTION, cause);
    }
}
